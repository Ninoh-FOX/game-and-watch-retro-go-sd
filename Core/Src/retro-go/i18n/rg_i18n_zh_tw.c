...
const lang_t lang_zh_tw LANG_DATA = {
    ...
    .s_Disable_Sprite_Limit = "禁用精靈限制",
    .s_Reset = "重設",
    .s_NES_CPU_OC = "超頻",
    .s_NES_Eject_Insert_FDS = "彈出/插入磁碟",
    .s_NES_Eject_FDS = "彈出磁碟",
    .s_NES_Insert_FDS = "插入磁碟",
    .s_NES_Swap_Side_FDS = "切換磁碟面",
    .s_NES_FDS_Side_Format = "磁碟 %d 面 %s",
    //=====================================================================
    ...
    .s_Theme_CoverV = "垂直捲動",
    .s_Theme_CoverH = "水平捲動",
    .s_Theme_CoverLightV = "垂直捲動_Light",
    .s_Theme_CoverLightH = "水平捲動_Light",
    ...
    .s_Size = "大小：",
    .s_Close = "× 關閉",
    .s_Delete_Rom_File = "刪除ROM",
    .s_Delete_Rom_File_Confirm = "刪除 '%s'？",
    .s_GameProp = "遊戲屬性",
    .s_Resume_game = "＞ 載入存檔",
    .s_New_game = "◇ 開始遊戲",
    .s_Del_favorite = "☆ 移除收藏",
    ...
    .s_DBGMCU_IDCODE = "調試 MCU 器件 ID 碼寄存器",
    .s_DBGMCU_CR = "調試 MCU 配置寄存器",
    .s_DBGMCU_clock = "調試 MCU 時鐘寄存器",
